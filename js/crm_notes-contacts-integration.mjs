import{g as T,a as D,t as r,c as E,s as F,b as V}from"./NcNoteCard-DZSuYX4--BfYn75fP.chunk.mjs";import{r as P,i as O,a as Z}from"./markdown-D3usn99V.chunk.mjs";const M=T("/apps/crm_notes/api"),j={note:"M14,17H7V15H14M17,13H7V11H17M17,9H7V7H17M19,3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3Z",openInNew:"M14,3V5H17.59L7.76,14.83L9.17,16.24L19,6.41V10H21V3M19,19H5V5H12V3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V12H19V19Z",file:"M13,9H18.5L13,3.5V9M6,2H14L20,8V20A2,2 0 0,1 18,22H6C4.89,22 4,21.1 4,20V4C4,2.89 4.89,2 6,2M15,18V16H6V18H15M18,14V12H6V14H18Z",pin:"M16,12V4H17V2H7V4H8V12L6,14V16H11.2V22H12.8V16H18V14L16,12Z",chevronDown:"M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z",plus:"M19,13H13V19H11V13H5V11H11V5H13V11H19V13Z"};function C(t,n=16){return`<svg viewBox="0 0 24 24" width="${n}" height="${n}" fill="currentColor" aria-hidden="true" focusable="false"><path d="${j[t]}" /></svg>`}function u(t){return String(t).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;").replace(/"/g,"&quot;").replace(/'/g,"&#39;")}function q(){return`<span class="crm-contacts-notes-loading" role="status">
	...
	`,t.appendChild(o),!document.getElementById("crm-contacts-integration-style")){const m=document.createElement("style");m.id="crm-contacts-integration-style",m.textContent=`
		...
		`,document.head.appendChild(m)}const g=o.querySelector(".crm-contacts-notes-toggle"),d=o.querySelector(".crm-contacts-notes-body"),s=o.querySelector(".crm-contacts-notes-chevron");g.addEventListener("click",()=>{const m=g.getAttribute("aria-expanded")!=="false";g.setAttribute("aria-expanded",m?"false":"true"),d.style.display=m?"none":"",s&&s.classList.toggle("crm-contacts-notes-chevron--collapsed",m)});const v=o.querySelector(".crm-contacts-notes-body");tt(o,v,n),R(v,n)}function tt(t,n,a){const o=t.querySelector(".crm-contacts-notes-add"),e=t.querySelector(".crm-contacts-notes-addform");if(!o||!e)return;const l=e.querySelector(".crm-contacts-addform-title"),i=e.querySelector(".crm-contacts-addform-type"),f=e.querySelector(".crm-contacts-addform-content"),c=e.querySelector(".crm-contacts-addform-hint"),g=e.querySelector(".crm-contacts-addform-cancel"),d=e.querySelector(".crm-contacts-addform-save"),s=t.querySelector(".crm-contacts-notes-toggle");let v={};d.disabled=!0,I().then(p=>{v=p,i.innerHTML="";for(const[N,$]of Object.entries(p)){const y=document.createElement("option");y.value=N,y.textContent=$.name,i.appendChild(y)}const x=Object.keys(p);x.length?(i.value=x[0],d.disabled=!1,c.dataset.crmNoTypes==="1"&&(delete c.dataset.crmNoTypes,c.hidden=!0,c.textContent="")):(d.disabled=!0,c.dataset.crmNoTypes="1",c.textContent=r("crm_notes","Create a note type first."),c.hidden=!1)}).catch(()=>{d.disabled=!0,c.dataset.crmNoTypes="1",c.textContent=r("crm_notes","Could not load note types."),c.hidden=!1});function m(){const p=[];if(l.value.trim()||p.push(r("crm_notes","Title")),i.value||p.push(r("crm_notes","Type")),!p.length){c.hidden=!0,c.textContent="";return}c.textContent=r("crm_notes","Required: {fields}",{fields:p.join(", ")}),c.hidden=!1}function h(){e.hidden=!0,o.setAttribute("aria-expanded","false"),e.reset(),c.dataset.crmNoTypes!=="1"&&(c.hidden=!0,c.textContent="")}o.addEventListener("click",()=>{const p=e.hidden;e.hidden=!p,o.setAttribute("aria-expanded",p?"true":"false"),p&&(s&&s.getAttribute("aria-expanded")==="false"&&s.click(),l.focus())}),g.addEventListener("click",h);const b=()=>{c.hidden||m()};l.addEventListener("input",b),i.addEventListener("change",b),e.addEventListener("submit",async p=>{p.preventDefault();const x=l.value.trim();if(!x||!i.value){m(),x?i.focus():l.focus();return}c.hidden=!0,c.textContent="",d.disabled=!0;const N=d.textContent;d.textContent=r("crm_notes","Saving…");try{const{data:$}=await E.post(`${M}/notes`,{contactUid:a,noteTypeId:Number(i.value),title:x,content:f.value||null}),y=n.querySelector(".crm-contacts-notes-empty");y&&y.remove(),n.insertBefore(z($,v),n.firstChild),h(),F(r("crm_notes","Note added."))}catch{V(r("crm_notes","Failed to add note."))}finally{d.disabled=!1,d.textContent=N}})}async function R(t,n){t.innerHTML=q();try{const[a,o]=await Promise.all([U(n,k,0),I()]);if(t.innerHTML="",a.length)a.forEach(e=>t.appendChild(z(e,o))),a.length===k&&et(t,n,o,a.length);else{const e=document.createElement("p");e.className="crm-contacts-notes-empty",e.textContent=r("crm_notes","No notes yet"),t.appendChild(e)}}catch{t.innerHTML="";const a=document.createElement("p");a.className="crm-contacts-notes-empty",a.textContent=r("crm_notes","Could not load notes."),t.appendChild(a);const o=document.createElement("button");o.type="button",o.className="crm-contacts-notes-retry",o.textContent=r("crm_notes","Retry"),o.addEventListener("click",()=>R(t,n)),t.appendChild(o),V(r("crm_notes","Failed to load CRM notes."))}}function et(t,n,a,o){const e=document.createElement("button");e.type="button",e.className="crm-contacts-notes-retry",e.textContent=r("crm_notes","Show more");let l=o;e.addEventListener("click",async()=>{e.disabled=!0,e.textContent=r("crm_notes","Loading…");try{const i=await U(n,k,l);i.forEach(f=>t.insertBefore(z(f,a),e)),l+=i.length,i.length===k?(e.disabled=!1,e.textContent=r("crm_notes","Show more")):e.remove()}catch{e.disabled=!1,e.textContent=r("crm_notes","Show more"),V(r("crm_notes","Failed to load more notes."))}}),t.appendChild(e)}let w=null;function B(){if(w&&w.isConnected){const n=w.querySelector(".crm-contacts-notes-panel");if(n&&n.dataset.crmContactUid===A(w))return}const t=[".contact-details-wrapper",".contact-details",".contact__details",'[class*="contact-detail"]',".app-content-detail"];for(const n of t){const a=document.querySelector(n);if(a){Y(a),w=a;return}}w=null}let L=!1;function _(){L||(L=!0,requestAnimationFrame(()=>{L=!1,B()}))}const nt=new MutationObserver(()=>{_()});function S(){nt.observe(document.body,{childList:!0,subtree:!0}),B()}document.readyState==="loading"?document.addEventListener("DOMContentLoaded",S):S(),window.addEventListener("hashchange",()=>{setTimeout(_,200)}),window.addEventListener("popstate",()=>{setTimeout(_,200)});
