import{g as C,a as A,t as r,s as H,c as L}from"./NcNoteCard-DZSuYX4--CUtNY3w_.chunk.mjs";import{r as T,i as S,a as I}from"./markdown-BmXc_xIq.chunk.mjs";const k=C("/apps/crm_notes/api"),U={note:"M14,17H7V15H14M17,13H7V11H17M17,9H7V7H17M19,3H5C3.89,3 3,3.89 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V5C21,3.89 20.1,3 19,3Z",openInNew:"M14,3V5H17.59L7.76,14.83L9.17,16.24L19,6.41V10H21V3M19,19H5V5H12V3H5C3.89,3 3,3.9 3,5V19A2,2 0 0,0 5,21H19A2,2 0 0,0 21,19V12H19V19Z",file:"M13,9H18.5L13,3.5V9M6,2H14L20,8V20A2,2 0 0,1 18,22H6C4.89,22 4,21.1 4,20V4C4,2.89 4.89,2 6,2M15,18V16H6V18H15M18,14V12H6V14H18Z",pin:"M16,12V4H17V2H7V4H8V12L6,14V16H11.2V22H12.8V16H18V14L16,12Z",chevronDown:"M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z"};function f(t,e=16){return`<svg viewBox="0 0 24 24" width="${e}" height="${e}" fill="currentColor" aria-hidden="true" focusable="false"><path d="${U[t]}" /></svg>`}function E(){return`<span class="crm-contacts-notes-loading" role="status">
		<span class="crm-contacts-spinner" aria-hidden="true"></span>
		<span class="crm-visually-hidden">${r("crm_notes","Loading…")}</span>
	</span>`}function R(t){if(typeof t!="string")return"var(--color-text-maxcontrast)";const e=t.trim();return/^#([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/.test(e)||/^hsla?\(\s*\d{1,3}\s*,\s*\d{1,3}%\s*,\s*\d{1,3}%\s*(,\s*(0|1|0?\.\d+)\s*)?\)$/.test(e)?e:"var(--color-text-maxcontrast)"}function V(t){const e=t.dataset?.contactUid||t.closest("[data-contact-uid]")?.dataset?.contactUid;if(e)return e;const n=window.location.hash.match(/contact:([^/]+)/)||window.location.pathname.match(/contact:([^/]+)/);return n?decodeURIComponent(n[1]):null}const g=50;async function M(t,e=g,n=0){const{data:o}=await L.get(`${k}/notes/contact/${encodeURIComponent(t)}`,{params:{limit:e,offset:n}});return o}let v=null;async function q(){return v||(v=L.get(`${k}/note-types`).then(({data:t})=>{const e={};for(const n of t)e[n.id]={name:n.name,color:n.color,icon:n.icon};return e}).catch(t=>{throw v=null,t})),v.catch(()=>({}))}const P=new Intl.DateTimeFormat(A().replace("_","-"),{year:"numeric",month:"short",day:"numeric",hour:"2-digit",minute:"2-digit"});function F(t){if(!t)return"";const e=new Date(t);return isNaN(e.getTime())?"":P.format(e)}function B(t){return t.name?t.name:t.filePath?t.filePath.split("/").pop():r("crm_notes","Attachment")}function N(t,e={}){const n=document.createElement("div");n.className="crm-contacts-note-item";const o=e[t.noteTypeId]||t.noteType||{},a=document.createElement("span");a.className="crm-contacts-type-badge";const l=R(o.color);a.style.background=l,a.style.color=T(l);const i=S(o.icon);if(i){const c=document.createElement("span");c.className="crm-contacts-type-badge-icon",c.setAttribute("aria-hidden","true"),c.innerHTML=`<svg viewBox="0 0 24 24" width="13" height="13" fill="currentColor" focusable="false"><path d="${i}" /></svg>`,a.appendChild(c)}const m=document.createElement("span");m.textContent=o.name||"",a.appendChild(m);const d=document.createElement("div");d.className="crm-contacts-note-header",d.appendChild(a);const u=document.createElement("h2");if(u.className="crm-contacts-note-title",u.textContent=t.title||"",d.appendChild(u),t.isPinned){const c=document.createElement("span");c.className="crm-contacts-pin-indicator",c.setAttribute("role","img"),c.setAttribute("aria-label",r("crm_notes","Pinned")),c.innerHTML=f("pin",16),d.appendChild(c)}if(n.appendChild(d),t.content){const c=document.createElement("div");c.className="crm-contacts-note-content",c.innerHTML=I(t.content),n.appendChild(c)}if(Array.isArray(t.files)&&t.files.length){const c=document.createElement("div");c.className="crm-contacts-note-files";for(const z of t.files){const h=document.createElement("span");h.className="crm-contacts-file-chip";const b=document.createElement("span");b.className="crm-contacts-file-chip-icon",b.innerHTML=f("file",12);const x=document.createElement("span");x.className="crm-contacts-file-chip-label",x.textContent=B(z),h.appendChild(b),h.appendChild(x),c.appendChild(h)}n.appendChild(c)}const s=document.createElement("span");return s.className="crm-contacts-note-date",s.textContent=F(t.createdAt),n.appendChild(s),n}async function D(t){const e=V(t);if(!e)return;const n=t.querySelector(".crm-contacts-notes-panel");if(n){if(n.dataset.crmContactUid===e)return;n.remove()}const o=document.createElement("div");o.className="crm-contacts-notes-panel",o.dataset.crmContactUid=e;const a=r("crm_notes","Open in CRM Notes (opens in a new tab)"),l=`crm-contacts-notes-body-${Math.random().toString(36).slice(2,10)}`;if(o.innerHTML=`
		<div class="crm-contacts-notes-header">
			...
			<a class="crm-contacts-open-app"
				href="${C("/apps/crm_notes")}#contact/${encodeURIComponent(e)}"
				title="${a}"
				aria-label="${a}"
				target="_blank"
	...
	`,t.appendChild(o),!document.getElementById("crm-contacts-integration-style")){const s=document.createElement("style");s.id="crm-contacts-integration-style",s.textContent=`
		...
		`,document.head.appendChild(s)}const i=o.querySelector(".crm-contacts-notes-toggle"),m=o.querySelector(".crm-contacts-notes-body"),d=o.querySelector(".crm-contacts-notes-chevron");i.addEventListener("click",()=>{const s=i.getAttribute("aria-expanded")!=="false";i.setAttribute("aria-expanded",s?"false":"true"),m.style.display=s?"none":"",d&&d.classList.toggle("crm-contacts-notes-chevron--collapsed",s)});const u=o.querySelector(".crm-contacts-notes-body");$(u,e)}async function $(t,e){t.innerHTML=E();try{const[n,o]=await Promise.all([M(e,g,0),q()]);if(t.innerHTML="",n.length)n.forEach(a=>t.appendChild(N(a,o))),n.length===g&&Z(t,e,o,n.length);else{const a=document.createElement("p");a.className="crm-contacts-notes-empty",a.textContent=r("crm_notes","No notes yet"),t.appendChild(a)}}catch{t.innerHTML="";const n=document.createElement("p");n.className="crm-contacts-notes-empty",n.textContent=r("crm_notes","Could not load notes."),t.appendChild(n);const o=document.createElement("button");o.type="button",o.className="crm-contacts-notes-retry",o.textContent=r("crm_notes","Retry"),o.addEventListener("click",()=>$(t,e)),t.appendChild(o),H(r("crm_notes","Failed to load CRM notes."))}}function Z(t,e,n,o){const a=document.createElement("button");a.type="button",a.className="crm-contacts-notes-retry",a.textContent=r("crm_notes","Show more");let l=o;a.addEventListener("click",async()=>{a.disabled=!0,a.textContent=r("crm_notes","Loading…");try{const i=await M(e,g,l);i.forEach(m=>t.insertBefore(N(m,n),a)),l+=i.length,i.length===g?(a.disabled=!1,a.textContent=r("crm_notes","Show more")):a.remove()}catch{a.disabled=!1,a.textContent=r("crm_notes","Show more"),H(r("crm_notes","Failed to load more notes."))}}),t.appendChild(a)}let p=null;function _(){if(p&&p.isConnected){const e=p.querySelector(".crm-contacts-notes-panel");if(e&&e.dataset.crmContactUid===V(p))return}const t=[".contact-details",".contact__details",'[class*="contact-detail"]',".app-content-detail"];for(const e of t){const n=document.querySelector(e);if(n){D(n),p=n;return}}p=null}let y=!1;function w(){y||(y=!0,requestAnimationFrame(()=>{y=!1,_()}))}const O=new MutationObserver(()=>{w()});document.addEventListener("DOMContentLoaded",()=>{O.observe(document.body,{childList:!0,subtree:!0}),_()}),window.addEventListener("hashchange",()=>{setTimeout(w,200)}),window.addEventListener("popstate",()=>{setTimeout(w,200)});
